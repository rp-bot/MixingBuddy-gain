...
Furthermore, tool-augmented multimodal agents like ControlLLM \cite{Liu_Lai_Gao_Cui_Li_Zhu_Lu_Chen_Qiao_Dai_etal_2025}, ModelScope-Agent \cite{Li_Chen_Yan_Shen_Xu_Wu_Zhang_Zhou_Chen_Cheng_etal_2023}, and HuggingGPT \cite{shen2023hugginggpt} can generate speech and music by invoking specialized audio tools. NExT-GPT also provides a framework that supports mixed inputs and outputs including audio, with diffusion models attached to the LLM \cite{Wu_Fei_Qu_Ji_Chua_2024}.