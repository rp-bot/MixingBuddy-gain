...
\begin{frame}\frametitle{\secname}\framesubtitle{Overview}
    \begin{columns}[T,totalwidth=\textwidth]
        ...
        \begin{itemize}
            ...
            \item<2-> \textbf{Input}: A Flawed mix and a text prompt.
...
\begin{frame}\frametitle{\secname}\framesubtitle{Dataset Synthesis}
    \begin{columns}[T,totalwidth=\textwidth]
        \column{0.5\textwidth}
        \begin{itemize}
            \item<1-3> \textbf{Audio-Driven Prompt Generation}: For this milestone, user instructions are implicit or generic, focusing the model purely on audio input to identify mixing flaws.
            \item<2-> \textbf{Flaw-Driven Templating}: a ``Flaw Category'' is identified, dictating the structure and content of the response.
...
\begin{frame}\frametitle{\secname}\framesubtitle{Flawed Mix Input}
    \begin{columns}[T,totalwidth=\textwidth]
        \column{0.5\textwidth}
        \begin{itemize}
