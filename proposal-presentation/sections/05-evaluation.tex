...
\begin{frame}\frametitle{\secname}\framesubtitle{Automated Evaluation}
    ...
    \column{0.5\textwidth}
        \centering
        \begin{itemize}
            \item<1-> \textbf{LLM-as-a-Judge}: Use LLMs to rate advice quality and relevance
            \item<2-> \textbf{Semantic Similarity}: Compare advice to expert annotations
        ...
        {\begin{minipage}[c][0.7\textheight][c]{\linewidth}
            \only<1->{\centering\includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{pictures/llm-as-judge.png}}
            \only<2->{\centering\includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{pictures/semantic-similarity.png}}
        \end{minipage}}
