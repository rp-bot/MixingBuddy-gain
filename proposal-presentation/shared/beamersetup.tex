...
{%
    ...
    \begin{textblock*}{100mm}(13.75cm,1cm)
        \includegraphics[height=.4cm,keepaspectratio]{shared/GT_COD_Center_Music_Technology_White.png}
    \end{textblock*}
}
...
\setbeamertemplate{title page}
{
    ...
    \begin{beamercolorbox}[wd=\paperwidth,ht=.4\paperheight,dp=0.6ex]{page number in head/foot}
        ...
        \vfill
        \begin{flushright}
            \href{http://www.gtcmt.gatech.edu}{\includegraphics[height=1cm,keepaspectratio]{shared/GT_COD_Center_Music_Technology_White.png}}\hspace*{2ex}
        \end{flushright}
    \end{beamercolorbox}%
}
...
\setbeamertemplate{footline}
{
  \leavevmode%
  \hbox{%
    \begin{beamercolorbox}[wd=\paperwidth,ht=2.25ex,dp=1ex,left,leftskip=1ex,rightskip=1ex]{page number in head/foot}%
